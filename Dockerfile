...
ENV PUID 99
ENV PGID 100
RUN apt-get update && apt-get -y install cron dialog libcam-pdf-perl perl libfurl-perl libxml-simple-perl libclone-perl libdatetime-perl libjson-perl libxml-writer-perl libhtml-tableextract-perl
